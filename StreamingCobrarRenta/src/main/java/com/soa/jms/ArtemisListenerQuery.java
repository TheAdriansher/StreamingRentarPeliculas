...
import com.soa.business.CobrarRentaBusiness;
...
public class ArtemisListenerQuery {
    ...
    @Autowired
    private CobrarRentaBusiness business;
    ...
    public void receive(String message) {
        ...
        Gson gson = new Gson();
        Solicitud solicitud = gson.fromJson(message, Solicitud.class);
        System.out.println(solicitud);
        Respuesta respuesta = business.cobrarMonto(solicitud);
        String colaSalida;
